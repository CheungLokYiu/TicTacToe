...
public class TicTacToeWithSaveGame extends TicTacToe {
    ...
    /**
     * Constructor prepares an object that is from subclass of TicTacToe.This constructor simply redirects System.out to file "ttt.txt"
 It shall use simple try-catch to silent all PrintStream related Exceptions.
    ...
    public TicTacToeWithSaveGame()
    {
        ...
        //PrintStream ps;
        try {
            // try to redirect thes System.out to file "ttt.txt"
